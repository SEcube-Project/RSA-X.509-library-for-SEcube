...
#define SE3_RESP_SUCCESS "OK"
#define SE3_RESP_FAILURE "KO"
#define	SE3_RET_SUCCESS 0			///< no error during the requested operation
...
enum {
	...
	SE3_ERR_KEY_NOT_FOUND = 402,	///< no key associated with the requested ID stored to flash
	SE3_ERR_KEY_DUPLICATE = 403,	///< trying to add a key with an already used ID
	SE3_ERR_KEY_SIZE = 404,			///< the requested key size is not allowed
	SE3_ERR_AUTH =	401,	   		///< SHA256HMAC Authentication failed
	SE3_ERR_OPENED = 300,   		///< session already opened and host trying to open a new one
	SE3_ERR_INPUT = 600,			///< unexpected input from host
	SE3_ERR_UNKNOWN_OP = 601,		///< no operation associated with the requested operation code
};
 ...
 *  @defgroup RSA
 *  @{
 *  @brief Use these values when using RSA
 */
typedef enum {
	SE3_RSA_KEYADD = 0,
	SE3_RSA_KEYGEN = 1,
	...
	SE3_RSA_X509_GEN = 9,
	SE3_RSA_X509_GET = 10,
	SE3_RSA_X509_DELETE = 11,
	SE3_RSA_X509_LIST = 12,
	SE3_RSA_X509_FIND = 13,
} se3_rsa_operation;
...
#define SE3_RSA_MAX_KEY_SIZE 8192
#define SE3_RSA_MAX_KEY_SIZE_BYTES SE3_RSA_MAX_KEY_SIZE/8
#define SE3_RSA_EXPONENT 65537
#define SE3_RSA_X509_SERIAL_SIZE 20
#define SE3_RSA_X509_DATE_SIZE 14
#define SE3_RSA_KEYGEN_REQ_SIZE 7 // ID (4B) + key length (2B) + key type (1B)
#define SE3_RSA_KEYGET_REQ_SIZE 4 // key ID
#define SE3_RSA_X509_CERT_REQ_SIZE (sizeof(uint32_t))

#define SE3_RSA_VALID_KEY_SIZES_N 4
static const int SE3_RSA_VALID_KEY_SIZES[SE3_RSA_VALID_KEY_SIZES_N] = {
	1024,
	2048,
	4096,
	8192
