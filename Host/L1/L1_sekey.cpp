...
void L1::SEkey_Maintenance(uint8_t *buffer, uint16_t *buflen){
...
bool L1::SEkey_DeleteAllKeys(std::vector<uint32_t>& keep){
	uint16_t data_len = 0;
	uint16_t resp_len = 0;
...
bool L1::SEkey_DeleteKey(uint32_t key_id){
	uint16_t data_len = 0;
	uint16_t resp_len = 0;
...
bool L1::SEkey_InsertKey(uint32_t key_id, uint16_t key_len, uint32_t dec_id, std::shared_ptr<uint8_t[]> key_data){
	uint16_t data_len = 0;
	uint16_t resp_len = 0;
...
bool L1::SEkey_Info(string& id, string& name, uint8_t mode)
{
	uint16_t data_len = 0;
	uint16_t resp_len = 0;
...
bool L1::SEkey_GetKeyEnc(uint32_t key_export_id, uint32_t key_wrapping_key, std::shared_ptr<uint8_t[]>& key_export_data, uint16_t& key_export_len){
	uint16_t data_len = 0;
	uint16_t resp_len = 0;
	uint16_t op, offset;
