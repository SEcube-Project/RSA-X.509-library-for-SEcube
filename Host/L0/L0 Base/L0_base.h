...
const uint32_t SE3_TIMEOUT = 10*1000; // milliseconds (10 seconds)
const uint32_t SE3_TIMEOUT_RSA_KEYGEN = 36000*1000; // milliseconds (1 hour) (only for RSA key generation, because it's time consuming)
